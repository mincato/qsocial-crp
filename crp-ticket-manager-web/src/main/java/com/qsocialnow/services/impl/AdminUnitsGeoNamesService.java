...
@Service("adminUnitsService")
@Scope(proxyMode = ScopedProxyMode.TARGET_CLASS)
public class AdminUnitsGeoNamesService implements AdminUnitsService {

    private static final Logger log = LoggerFactory.getLogger(AdminUnitsGeoNamesService.class);
    ...
    public List<AdminUnit> findUnitAdminsByGeoIds(String query, Object parameters) {
        try {
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(adminUnitServiceUrl).queryParam(
                    "geoNameIds", query);
